...
curseur.execute(f"INSERT INTO JEUX (Nom_de_jeu,ID_Dev,Date_publication,Date_Derniere_Maj,ID_Type,Description,Nombre_joueur,Pegi,Lien,ID_Langue,ID_Licence,image_jeu,Publication) VALUES ('Sky-Rimes',1,DATE('now'),DATE('now'),1,'Jeu trop ouf, vrmt trop incroyable, à mourir de rire, 20/20 selon IGN, tout le monde aime',1,16,'https://www.youtube.com/',1,1,'https://imgur.com/',0)")
curseur.execute(f"INSERT INTO JEUX (Nom_de_jeu,ID_Dev,Date_publication,Date_Derniere_Maj,ID_Type,Description,Nombre_joueur,Pegi,Lien,ID_Langue,ID_Licence,image_jeu,Publication) VALUES ('Raquette-League',1,'2020-02-01',DATE('now'),2,'Jeu trop ouf, vrmt trop incroyable, à mourir de rire, 20/20 selon IGN, tout le monde aime',1,16,'https://www.youtube.com/',1,1,'https://imgur.com/',0)")
curseur.execute(f"INSERT INTO JEUX (Nom_de_jeu,ID_Dev,Date_publication,Date_Derniere_Maj,ID_Type,Description,Nombre_joueur,Pegi,Lien,ID_Langue,ID_Licence,image_jeu,Publication) VALUES ('Boom-Plage',1,DATE('now'),DATE('now'),2,'Jeu trop ouf, vrmt trop incroyable, à mourir de rire, 20/20 selon IGN, tout le monde aime',1,16,'https://www.youtube.com/',1,1,'https://imgur.com/',0)")
curseur.execute(f"INSERT INTO JEUX (Nom_de_jeu,ID_Dev,Date_publication,Date_Derniere_Maj,ID_Type,Description,Nombre_joueur,Pegi,Lien,ID_Langue,ID_Licence,image_jeu,Publication) VALUES ('Mein-Kraft',1,'2020-07-13',DATE('now'),1,'Jeu trop ouf, vrmt trop incroyable, à mourir de rire, 20/20 selon IGN, tout le monde aime',1,16,'https://www.youtube.com/',1,1,'https://imgur.com/',0)")
curseur.execute(f"INSERT INTO JEUX (Nom_de_jeu,ID_Dev,Date_publication,Date_Derniere_Maj,ID_Type,Description,Nombre_joueur,Pegi,Lien,ID_Langue,ID_Licence,image_jeu,Publication) VALUES ('Jenshin',1,'2021-01-29',DATE('now'),3,'Jeu trop ouf, vrmt trop incroyable, à mourir de rire, 20/20 selon IGN, tout le monde aime',1,16,'https://www.youtube.com/',1,1,'https://imgur.com/',0)")
...
curseur.execute(requete10)
curseur.execute(requete11)
curseur.execute(requete12)
